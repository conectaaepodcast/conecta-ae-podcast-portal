  ...
  return (
    <article>
      <div className="mb-6 text-sm">
        <Link href="/podcasts" className="text-blue-700 hover:underline">
          ← Podcasts
        </Link>
      </div>
      ...
      <header className="border-b border-zinc-100 pb-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          ...
          <div>
            ...
            {podcast.summary ? (
              <p className="mt-4 text-lg text-zinc-600">{podcast.summary}</p>
            ) : null}
      ...
      {yt ? (
        <div className="mt-10 max-w-3xl">
          <h2 className="mb-3 text-lg font-semibold text-zinc-900">Vídeo</h2>
      ...
      <section className="mt-16 border-t border-zinc-200 pt-12">
        ...
        <p className="mt-1 text-sm text-zinc-600">Últimos podcasts publicados.</p>
